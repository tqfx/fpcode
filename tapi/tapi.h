...
*/
extern int tapi_confirm(const char *title, const char *hint);
 ...
 * @param[in]    title set title of dialog (optional)
 * @param[in]    valus comma delim values to use (required)
 * @return       0 success -1 failure -2 error
*/
extern int tapi_checkbox(char ***text, int **index, int *n, const char *title, const char *values);
 ...
 * @return       0 success -1 failure -2 error
*/
extern int tapi_counter(long int *pl, const char *title, const char *values);
 ...
 * @return       0 success -1 failure -2 error
*/
extern int tapi_radio(char **text, int *index, const char *title, const char *values);
 ...
 * @return       0 success -1 failure -2 error
*/
extern int tapi_sheet(char **text, int *index, const char *title, const char *values);
 ...
 * @return       0 success -1 failure -2 error
*/
extern int tapi_spinner(char **text, int *index, const char *title, const char *values);
 ...
 * @return       0 success -1 failure -2 error
*/
extern int tapi_text(char **dst, const char *title, const char *hint, const char *op);
/**
