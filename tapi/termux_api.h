 ...
 * ]
*/
extern int termux_call_log(char **out, int l, int o);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_camera_photo(const char *filename, unsigned int c);
 ...
 *  }
*/
extern int termux_dialog_text(char **out, const char *t, const char *i, const char *op);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_dialog_speech(char **out, const char *t, const char *i);
 ...
 *  }
*/
extern int termux_dialog_spinner(char **out, const char *t, const char *v);
 ...
 *  }
*/
extern int termux_dialog_sheet(char **out, const char *t, const char *v);
 ...
 *  }
*/
extern int termux_dialog_radio(char **out, const char *t, const char *v);
 ...
 *   }
*/
extern int termux_dialog_date(char **out, const char *t, const char *d);
 ...
 *  }
*/
extern int termux_dialog_counter(char **out, const char *t, const char *r);
 ...
 *  }
*/
extern int termux_dialog_checkbox(char **out, const char *t, const char *v);
 ...
 *  }
*/
extern int termux_dialog_confirm(char **out, const char *t, const char *i);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_download(const char *url, const char *t, const char *d);
 ...
 *  }
*/
extern int termux_fingerprint(char **out, const char *t, const char *d, const char *s, const char *c);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_infrared_transmit(char **out, int f, int num);
 ...
 *  }
*/
extern int termux_location(char **out, const char *p, const char *r);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_media_scan(char **out, const char *filename, const char *op);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_media_player(char **out, const char *op, const char *filename);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_microphone_record(char **out, const Termux_record *struct_op, const char *op);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_open(const char *path_url, int select, const char *type);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_sensor(char **out, const char *s, int ms, int n, const char *op);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_sms_list(char **out, const char *t, int l, int o, const char *op);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_sms_send(const char *numbers, const char *text);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_toast(const char *text, const char *c, const char *b, const char *g, int s);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_tts_speak(const Termux_tts *op, const char *text);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_usb(char **out, const char *path, const char *e, const char *op);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_vibrate(int ms, int mute);
 ...
 *  ]
*/
extern int termux_volume(const char *s, int v);
 ...
 * @return       int 0 sucess -1 failure
*/
extern int termux_wallpaper(const char *file_url, int screen);
