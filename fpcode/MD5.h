...
*/
extern void hmac_md5(const void *text, size_t text_len,const void *key, size_t key_len, unsigned char *digest)
#else
/** 
 * @brief        Main function of the HMAC-MD5. gets the key and the text, and
...
*/
extern char *hmac_md5(const void *text, size_t text_len, const void *key, size_t key_len);
#endif
